...
const AboutUs = () => {
  return (
    <div className="AboutUsPage-external">
      ...
      <span className="AboutUsPage-text">
        {" "}
        Προσφέρουμε μια πλατφόρμα για εύκολη εξυπηρέτηση όσον που ψάχνουν
        δραστηριότητες για παιδιά και νέους με πλήρεις δυνατότητες αγοραπωλησίας
        εικoνικών εισητηρίων.
      </span>
